...
- **Blocking**: GitHub's native issue dependencies. Where dependencies aren't available, use a `Blocked by: #<n>, #<n>` line at the top of the child body. A ticket is unblocked when every blocker is closed.
