...
export function segmentAnchorLabel(anchorIndex) {
...
export function setupSegmentJumpNav(container) {
    if (!container) return;
...
export function setupSegmentScrollTracking(container) {
    if (!container) return;
    let raf = null;
