...
**Inner memory**:
What the extension chat's model sees: the main chat (depth-limited, with the summary integration covering older parts) plus all non-hidden exchanges. The Inner Voice may recall, answer, or invent from it freely; invented callbacks can become true.
